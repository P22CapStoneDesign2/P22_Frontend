...
import { ROUTES, studentMaterialViewerPath } from '../../../shared/constants/routes.js'
...
export default function StudentMaterialsPage() {
  return (
    <AppLayout
      ...
      contentClassName="edu-stu-mat-list-app-layout-content"
    >
      <div className="edu-stu-mat-list">
        <h1 className="edu-stu-mat-list__title">교안 보기</h1>
        <p className="edu-stu-mat-list__intro">(정세영)pdf뷰어를 버튼에 연결하느라 임시로 만들어둔 화면입니다. 구현 다시 하시면 됩니다</p>
